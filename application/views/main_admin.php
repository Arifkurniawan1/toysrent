				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-header">
							...
							<p class="lead">Menampilkan daftar Pemesanan Barang</p>
						</div>
				<div class="table100 ver6 m-b-110">
					<table data-vertable="ver6">
						<thead>
							<tr class="row100 head">
								<th class="column100 column1" data-column="column1">ID Pemesanan</th>
								<th class="column100 column2" data-column="column2">Waktu Pemesanan</th>
								<th class="column100 column3" data-column="column3">Jumlah Pemesanan</th>
								<th class="column100 column4" data-column="column4">Harga Sewa</th>
								<th class="column100 column5" data-column="column5">Ongkos</th>
								<th class="column100 column4" data-column="column4">No KTP Pemesan</th>
								<th class="column100 column5" data-column="column5">Status Barang</th>
							</tr>
						</thead>
						<tbody>
						<?php
						...
						?>
							<tr class="row100">
								<td class="column100 column1" data-column="column1"> <?php echo $i->id_pemesanan; ?> </td>
