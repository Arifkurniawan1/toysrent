	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/kids.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo site_url('user/input_mmbr')?>" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Nomor KTP">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter Tanggal Lahir">
						<input class="input100" type="date" data-date-format="YYYY-MM-DD" name="tanggal_lahir" placeholder="Tanggal Lahir">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                    
                    <div class="wrap-input100 validate-input" data-validate = "Enter Nomor Telepon">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter Alamat">
                        <input class="input100" type="text" name="jalan" placeholder="Jalan">
                        <input class="input100" type="text" name="nomor" placeholder="Nomor">
                        <input class="input100" type="text" name="kota" placeholder="Kota">
                        <input class="input100" type="text" name="kodepos" placeholder="Kode Pos">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
