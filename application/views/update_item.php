	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/img/kids.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo site_url("admin/edit_item")?>" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Nama">
						<input class="input100" type="text" name="nama" value="<?php echo $data['nama']; ?>">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter Deskripsi">
						<input class="input100" type="text" name="deskripsi" value="<?php echo $data['deskripsi']; ?>">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter Rentang Usia">
						<input class="input100" type="text" name="usia_dari" value="<?php echo $data['usia_dari']; ?>">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter Rentang Usia">
						<input class="input100" type="text" name="usia_sampai" value="<?php echo $data['usia_sampai']; ?>">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter Bahan">
						<input class="input100" type="text" name="bahan" value="<?php echo $data['bahan']; ?>">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
